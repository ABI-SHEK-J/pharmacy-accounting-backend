...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('journal', '0003_sale_credit_sale_debit'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='purchase', to='journal.journal')),
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='purchases', to='chart_of_accounts.chartofaccount')),
            ],
            options={
                'ordering': ['-date', '-id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='journal.purchase')),
            ],
            options={
                'ordering': ['id'],
            },
